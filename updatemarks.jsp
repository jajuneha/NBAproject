response.sendRedirect("updatetar.jsp");<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
...
<body>
 ...
 <br><br>
  ...
  String subject = (String)session.getAttribute("subject");
	...
	System.out.print(subject + username);
  ...
  for(i=1;i<=num;i++)
  {
	  %>
	  	<div class="row" id="one">
	  	 	<div class="col-lg-2" id="a2">3<%=i%></div>
	  	 	<%
	  	 		int j;
	  	 		for(j=1;j<=3;j++)
	  	 		{
